...
// OpenconfigSystem_System_Aaa_Accounting_Config_AccountingMethod_Union is an interface that is imple-sysmented by valid types for the union
...
const (
	...
	//OpenconfigOpenflow_Transport_POL E_OpenconfigOpenflow_Transport = 3
)
